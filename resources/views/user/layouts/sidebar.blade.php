 ...
 <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="{{url('user/profile')}}"><i class="app-menu__icon fa fa-user-circle-o" aria-hidden="true"></i><span class="app-menu__label">Profile</span></a></li>
        <li><a class="app-menu__item" href="{{url('user/money-shield')}}"><i class="app-menu__icon fa fa-shield" aria-hidden="true"></i><span class="app-menu__label">Money shield Calculator</span></a></li>
